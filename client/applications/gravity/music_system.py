...
class music_system:
    def __init__(self,music_file = None ):
        ...
        audio.get_track("Pads").play_clip(audio.get_clip("audio/Tram01_Pads.ogg"), True).set_volume(0)
        audio.get_track("Lead").play_clip(audio.get_clip("audio/Tram01_Leads.ogg"), True).set_volume(1.0)
        audio.get_track("PickupHi").play_clip(audio.get_clip("audio/Tram01_PickupHi.ogg"), True).set_volume(0.0)
        audio.get_track("PickupLow").play_clip(audio.get_clip("audio/Tram01_PickupLow.ogg"), True).set_volume(0.0)
