...
sliders = [ "brush_size", "brush_power", "brush_alpha", "pressure dynamics", "brush_jitter", "brush_noise" ]
...
make_button_command = "convert -background black -fill white -font Consolas -pointsize 10 label:\"{$button_name}\" label_{$button_name}.bmp & composite -gravity Center label_{$button_name}.bmp button_{$mode}.bmp button_{$button_idx}_{$mode}.bmp"
